        ...
        def _post() -> str:
            try:
                ...
                if choices:
                    ...
                    # LINEAJE: enforce() `message` at api->agent post_tool — scan flagged AI_DAT_SEC_027 (Enforce output data minimization for model, tool, and API responses.). Mask/block; do not remove without review. site_id='site:sha256:73c7ae65179045b5518de53c90348c364df22d56308dc50e84af84ecec964a93'
                ...
                # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_APP_SEC_028 (Do not use LLMs from the organization's disallowed list); AI_APP_SEC_070 (Detect and block all forms of prompt injection attacks in user inputs and file contents). Mask/block; do not remove without review. site_id='site:sha256:43f281407de8ee4454d2b0b7402c01a7036fee1885dc25855039e04b239fec1a'
                _gr_client = _lineaje_load_gr_client()
