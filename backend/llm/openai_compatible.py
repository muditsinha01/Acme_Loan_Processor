        ...
        def _post() -> str:
            try:
                ...
                if choices:
                    ...
                    # LINEAJE: enforce() `message` at api->agent post_tool — scan flagged AI_APP_SEC_067 (Detect direct string interpolation of untrusted input into LLM prompts); AI_APP_SEC_071 (Enforce chemical, biological, radiological, or nuclear (CBRN) threat prevention safeguards in AI-enabled systems); AI_IAC_015 (Enforce URL allowlists for agent fetches, tools, and outbound HTTP.). Mask/block; do not remove without review. site_id='site:sha256:73c7ae65179045b5518de53c90348c364df22d56308dc50e84af84ecec964a93'
                    ...
                    try:
                        message = _gr_client.enforce(_gr_site, message, content_type='application/json', variable_name='message', source_file=__file__, before_line=63)
