...
class PaperclipBoardAgent(AcmeLoanAgentFramework):
    ...
    async def handle(self, context: dict[str, Any]) -> dict[str, Any]:
        ...
        _lineaje_pulled_skill_evidence = {'skill_id': (pulled_skill or {}).get('id') or (pulled_skill or {}).get('skill_id') or '', 'skill_path': str((pulled_skill or {}).get('path') or (pulled_skill or {}).get('skill_path') or '')}
        _gr_client = _lineaje_load_gr_client()
