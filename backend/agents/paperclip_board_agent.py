...
class PaperclipBoardAgent(AcmeLoanAgentFramework):
    ...
    def __init__(self):
        ...
        try:
            ...
            # LINEAJE: enforce() `self.skill` at skill_manifest->skill_check skill_check — scan flagged AI_SKILL_DAT_SEC_001 (Do not allow skills that exfiltrate data); AI_SKILL_SEC_001 (Do not allow malicious skills); AI_SKILL_SEC_002 (Do not allow suspicious skills). Mask/block; do not remove without review. site_id='site:sha256:95ebbc6b46069212380555f0f3d86962e71f767c6fd40a2ac91af3529228ea41'
            _lineaje_self_skill_evidence = {'skill_id': self.SKILL_ID}
            _gr_client = _lineaje_load_gr_client()
            _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:95ebbc6b46069212380555f0f3d86962e71f767c6fd40a2ac91af3529228ea41', phase='skill_check', boundary={'source': 'skill_manifest', 'sink': 'skill_check'}, candidate_policies=[{'policy_id': 'AI_SKILL_SEC_001', 'guardrail_id': 'Block Malicious Skills', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='skill_manifest', destination_type='skill_check')
            try:
                _lineaje_self_skill_evidence = _gr_client.enforce(_gr_site, _lineaje_self_skill_evidence, content_type='application/json')
                self.skill = load_marketplace_fixture(self.SKILL_ID)
            except _gr_client.GuardrailUnavailableError:
                # LINEAJE: enforce() `self.skill` at skill_manifest->skill_check skill_check — scan flagged AI_SKILL_DAT_SEC_001 (Do not allow skills that exfiltrate data); AI_SKILL_SEC_001 (Do not allow malicious skills); AI_SKILL_SEC_002 (Do not allow suspicious skills). Mask/block; do not remove without review. site_id='site:sha256:520b74d149346ca5b88dd93d8c6e9b5731a194f5dfa9dc2fae4938a728290696'
                _lineaje_self_skill_evidence = {'skill_id': self.SKILL_ID}
                _gr_client = _lineaje_load_gr_client()
                _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:520b74d149346ca5b88dd93d8c6e9b5731a194f5dfa9dc2fae4938a728290696', phase='skill_check', boundary={'source': 'skill_manifest', 'sink': 'skill_check'}, candidate_policies=[{'policy_id': 'AI_SKILL_SEC_001', 'guardrail_id': 'Block Malicious Skills', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='skill_manifest', destination_type='skill_check')
                try:
                    _lineaje_self_skill_evidence = _gr_client.enforce(_gr_site, _lineaje_self_skill_evidence, content_type='application/json')
                    self.skill = load_marketplace_fixture(self.SKILL_ID)
                except _gr_client.GuardrailUnavailableError:
                    # LINEAJE: enforce() `self.skill` at skill_manifest->skill_check skill_check — scan flagged AI_APP_SEC_070 (Detect and block all forms of prompt injection attacks in user inputs and file contents). Mask/block; do not remove without review. site_id='site:sha256:ae44a615972ffe030934f1f392a62a580adba8c0bce2ffc8f398b01dfbb5b64c'
                    _lineaje_self_skill_evidence = {'skill_id': self.SKILL_ID}
                    _gr_client = _lineaje_load_gr_client()
                    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:ae44a615972ffe030934f1f392a62a580adba8c0bce2ffc8f398b01dfbb5b64c', phase='skill_check', boundary={'source': 'skill_manifest', 'sink': 'skill_check'}, candidate_policies=[{'policy_id': 'AI_SKILL_SEC_001', 'guardrail_id': 'Block Malicious Skills', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='skill_manifest', destination_type='skill_check')
                    try:
                        _lineaje_self_skill_evidence = _gr_client.enforce(_gr_site, _lineaje_self_skill_evidence, content_type='application/json')
                        self.skill = load_marketplace_fixture(self.SKILL_ID)
                    except _gr_client.GuardrailUnavailableError:
                        # LINEAJE: enforce() `self.skill` at skill_manifest->skill_check skill_check — scan flagged AI_SKILL_DAT_SEC_001 (Do not allow skills that exfiltrate data); AI_SKILL_SEC_001 (Do not allow malicious skills); AI_SKILL_SEC_002 (Do not allow suspicious skills). Mask/block; do not remove without review. site_id='site:sha256:e0dfbc93abb688322718cc844cfffd177502d3b70c19bbd274bf3b1f5bd31e6d'
                        _lineaje_self_skill_evidence = {'skill_id': self.SKILL_ID}
                        _gr_client = _lineaje_load_gr_client()
                        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:e0dfbc93abb688322718cc844cfffd177502d3b70c19bbd274bf3b1f5bd31e6d', phase='skill_check', boundary={'source': 'skill_manifest', 'sink': 'skill_check'}, candidate_policies=[{'policy_id': 'AI_SKILL_SEC_001', 'guardrail_id': 'Block Malicious Skills', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='skill_manifest', destination_type='skill_check')
                        try:
                            _lineaje_self_skill_evidence = _gr_client.enforce(_gr_site, _lineaje_self_skill_evidence, content_type='application/json')
                            self.skill = load_marketplace_fixture(self.SKILL_ID)
                        except _gr_client.GuardrailUnavailableError:
        ...
        if not self.skill["loaded"]:
            ...
            _gr_client = _lineaje_load_gr_client()
            _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:b1ca0bc7b01b38e5436c450d25a0c66e8af19d6276c035daf7e12b46ee2006ad', phase='log_emit', boundary={'source': 'log', 'sink': 'log'}, candidate_policies=[], fail_mode='BLOCK', source_type='agent', destination_type='log')
            try:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:9e300ae34bb395f4ade220344faaa3851954c0fbe290926d5700a9e74f182be1', phase='data_egress', boundary={'source': 'agent_message', 'sink': 'user_interface'}, candidate_policies=[], fail_mode='BLOCK', source_type='agent', destination_type='user_interface')
        try:
    ...
    def _fetch_dashboard(self, env: dict[str, str]) -> str:
        ...
        try:
            ...
            _gr_client = _lineaje_load_gr_client()
            _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:e5d4bf52f9568e50f4a76f97e761e4d48e5bcd02891a2b7cc597cc32955ece6d', phase='log_emit', boundary={'source': 'log', 'sink': 'log'}, candidate_policies=[], fail_mode='BLOCK', source_type='agent', destination_type='log')
            try:
                _lineaje_payload = _gr_client.enforce(_gr_site, _lineaje_payload, content_type='application/json')
            except _gr_client.GuardrailUnavailableError:
                pass
    ...
    async def call_agent_model(
        ...
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:9019094c1169f4d4b7290c92352289e6da8bbcae7468854f26fcd3a20a7b6512', phase='pre_model', boundary={'source': 'agent_message', 'sink': 'model'}, candidate_policies=[], fail_mode='BLOCK', source_type='agent', destination_type='llm')
        try:
            _lineaje_messages = await __import__('asyncio').to_thread(lambda: _gr_client.enforce(_gr_site, _lineaje_messages, content_type='application/json', variable_name='_lineaje_messages', source_file=__file__, before_line=144))
        except _gr_client.GuardrailUnavailableError:
            pass
        except PermissionError:
            raise
