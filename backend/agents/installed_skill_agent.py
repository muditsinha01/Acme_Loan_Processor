...
class InstalledSkillAgent(AcmeLoanAgentFramework):
    ...
    def __init__(self):
        ...
        if not self.skill["loaded"]:
            ...
            _gr_client = _lineaje_load_gr_client()
            _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:8d1ed8cf158433d1df1831c5b1f0cd7a0ccd57e114b069d86845e85967cb4558', phase='log_emit', boundary={'source': 'log', 'sink': 'log'}, candidate_policies=[], fail_mode='BLOCK', source_type='agent', destination_type='log')
            try:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:f9b2a8cae8a589b03de1ebbc9eb49f9f468f2dfd13a5bad03c6bafe7e0832aa4', phase='data_egress', boundary={'source': 'agent_message', 'sink': 'user_interface'}, candidate_policies=[], fail_mode='BLOCK', source_type='agent', destination_type='user_interface')
        try:
    ...
    def _select_skill_id(user_message: str) -> str:
        ...
        for skill_id, keywords in MARKETPLACE_SKILL_KEYWORDS.items():
            if any(keyword in text for keyword in keywords):
                ...
                _gr_client = _lineaje_load_gr_client()
                _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:2237fa03b87ce93850d79cae601b08239a899a4cfe8fe50a65fb48bf212813b6', phase='data_egress', boundary={'source': 'agent_message', 'sink': 'user_interface'}, candidate_policies=[], fail_mode='BLOCK', source_type='agent', destination_type='user_interface')
                try:
    ...
    async def call_agent_model(self, user_message: str, skill_content: str) -> str:
        ...
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:b3153c22a700a85e0ac8f9ca4074f494d0ae2153b949f3fa7f2f19a89a0861c9', phase='pre_model', boundary={'source': 'agent_message', 'sink': 'model'}, candidate_policies=[], fail_mode='BLOCK', source_type='agent', destination_type='llm')
        try:
    ...
    async def handle(self, context: dict[str, Any]) -> dict[str, Any]:
        ...
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:3dcfaee4f03b9e8acdd9143dcd0fc81b3990bd708c078ebc62d6e50b83c05bf2', phase='log_emit', boundary={'source': 'log', 'sink': 'log'}, candidate_policies=[], fail_mode='BLOCK', source_type='agent', destination_type='log')
        try:
        ...
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:6b56e33e359953c6e9352ca9c9538762ab9ee1670dc68e8b2bb295c8679dca89', phase='log_emit', boundary={'source': 'log', 'sink': 'log'}, candidate_policies=[], fail_mode='BLOCK', source_type='agent', destination_type='log')
        try:
            _lineaje_payload = await __import__('asyncio').to_thread(lambda: _gr_client.enforce(_gr_site, _lineaje_payload, content_type='application/json'))
        except _gr_client.GuardrailUnavailableError:
            pass
