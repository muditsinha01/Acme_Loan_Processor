...
class InstalledSkillAgent(AcmeLoanAgentFramework):
    ...
    def __init__(self):
        ...
        # LINEAJE: enforce() `_lineaje_payload` at skill_manifest->skill_check skill_check — scan flagged AI_SKILL_DAT_SEC_001 (Do not allow skills that exfiltrate data); AI_SKILL_SEC_001 (Do not allow malicious skills); AI_SKILL_SEC_002 (Do not allow suspicious skills). Mask/block; do not remove without review. site_id='site:sha256:e57f2e19139e7f05a458936b1a9d45e51958b53238f853da9edac6410233a4ef'
        _lineaje__lineaje_payload_evidence = {'_lineaje_payload': _lineaje_payload, 'skill_id': str(_lineaje_payload), 'project': 'source-code'}
        ...
        self.skill = load_skill(_lineaje_payload)
    ...
    async def handle(self, context: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            skill_id = ""
            __import__("logging").getLogger("lineaje.gr_client").warning("gr_client[skill_manifest->skill_check]: quarantined skill not loaded")
        # LINEAJE: enforce() `skill_id` at skill_manifest->skill_check skill_check — scan flagged AI_SKILL_SEC_001 (Do not allow use of malicious skills). Mask/block; do not remove without review. site_id='site:sha256:e1fcd24b24cc2385bfa632d0166b110dfcd84a36761beb622f0749cfb7b61e3d'
        _lineaje_skill_id_evidence = {'skill_id': skill_id, 'project': 'source-code'}
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:e1fcd24b24cc2385bfa632d0166b110dfcd84a36761beb622f0749cfb7b61e3d', phase='skill_check', boundary={'source': 'skill_manifest', 'sink': 'skill_check'}, candidate_policies=[{'policy_id': 'AI_SKILL_DAT_SEC_001', 'guardrail_id': 'Block Data-Exfiltrating Skills', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_SKILL_SEC_001', 'guardrail_id': 'Block Malicious Skills', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_SKILL_SEC_002', 'guardrail_id': 'Block Suspicious Skills', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_SKILL_SEC_003', 'guardrail_id': 'Block Pending-Scan Skills', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_SKILL_SEC_004', 'guardrail_id': 'Warn Unscanned Skills', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='skill_manifest', destination_type='skill_check')
        try:
            _lineaje_skill_id_evidence = await __import__('asyncio').to_thread(lambda: _gr_client.enforce(_gr_site, _lineaje_skill_id_evidence, content_type='application/json'))
            skill_id = _lineaje_skill_id_evidence.get('skill_id', skill_id) if isinstance(_lineaje_skill_id_evidence, dict) else skill_id
        except _gr_client.GuardrailUnavailableError:
        ...
        try:
            ...
            pass
        # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_DAT_SEC_012 (Mask PII on user interfaces); AI_SKILL_SEC_001 (Do not allow use of malicious skills). Mask/block; do not remove without review. site_id='site:sha256:6b56e33e359953c6e9352ca9c9538762ab9ee1670dc68e8b2bb295c8679dca89'
        _gr_client = _lineaje_load_gr_client()
        ...
        _lineaje_skill_content_evidence = {'skill_content': skill_content, 'skill_body': skill_content, 'skill_source': skill_source, 'scan_status': scan_status, 'skill_name': skill_name, 'skill_id': skill_id, 'project': 'source-code'}
        _gr_client = _lineaje_load_gr_client()
        ...
        try:
            ...
            skill_content = ""
            __import__("logging").getLogger("lineaje.gr_client").warning("gr_client[skill_manifest->skill_check]: quarantined skill not loaded")
        # LINEAJE: enforce() `skill_content` at skill_manifest->skill_check skill_check — scan flagged AI_SKILL_SEC_001 (Do not allow use of malicious skills). Mask/block; do not remove without review. site_id='site:sha256:229df5f36d8ac860d124b98d5d9f3e16a7e297ba4e6a52ad28691d38c5c14345'
        _lineaje_skill_content_evidence = {'skill_content': skill_content, 'skill_body': skill_content, 'skill_source': skill_source, 'scan_status': scan_status, 'skill_name': skill_name, 'skill_id': skill_id, 'project': 'source-code'}
        _gr_client = _lineaje_load_gr_client()
