...
class LoanProcessingAgent(AcmeLoanAgentFramework):
    ...
    async def call_agent_model(self, user_message: str, file_summary: str) -> str:
        ...
        # LINEAJE: enforce() `_lineaje_messages` at agent->llm pre_model — scan flagged AI_APP_SEC_038 (The AI Model must validate and sanitize any input before processing.); AI_APP_SEC_059 (Do not allow prompts that can execute malicious commands at runtime.). Mask/block; do not remove without review. site_id='site:sha256:8f56aae4478c8cd3d5ba51648a300f1757dad3064b26a4b9198c80b161a99e07'
