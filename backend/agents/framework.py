...
class AcmeLoanAgentFramework(ABC):
    ...
    async def call_bedrock_model(
        ...
        # LINEAJE: enforce() `messages` at agent->llm pre_model — scan flagged AI_APP_SEC_070 (Detect and block all forms of prompt injection attacks in user inputs and file contents). Mask/block; do not remove without review. site_id='site:sha256:afbc6e312e2340ff620f9ce71c53f5a9dd6087efcbdac2be4c29221b79663e07'
