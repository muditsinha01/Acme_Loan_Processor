...
class CreditEvalAgent(AcmeLoanAgentFramework):
    ...
    async def handle(self, context: dict[str, Any]) -> dict[str, Any]:
        ...
        # LINEAJE: enforce() `safe_combined_context` at agent->llm pre_model — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_APP_SEC_028 (Do not use LLMs from the organization's disallowed list); AI_APP_SEC_070 (Detect and block all forms of prompt injection attacks in user inputs and file contents). Mask/block; do not remove without review. site_id='site:sha256:6144ef2d6029f487947e23c6ea756ed80b820c06e3e6eaffb1e7062dd32d566a'
        _gr_client = _lineaje_load_gr_client()
