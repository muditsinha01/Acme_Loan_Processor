...
class CreditEvalAgent(AcmeLoanAgentFramework):
    ...
    async def handle(self, context: dict[str, Any]) -> dict[str, Any]:
        ...
        # Encrypt PII fields before including them in the context sent to the model
        encrypted_ssn = self.encrypt_pii(borrower_record['ssn'])
        encrypted_address = self.encrypt_pii(borrower_record['address'])
